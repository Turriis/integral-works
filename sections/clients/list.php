                  ...
                  <table class="table table-striped project-orders-table">
                    <thead>
                      ...
                      <tr>
                        ...
                        <th><input id="client_name_filt" onkeypress='filterClients(event);' value='<?php echo $_GET['client_name_filt']  ?? null ?>' class='input-filter'></th>
                        <th><input id="client_email_filt" onkeypress='filterClients(event);' value='<?php echo $_GET['client_email_filt'] ?? null ?>' class='input-filter'></th>
                        <th><input id="client_rfc_filt" onkeypress='filterClients(event);' value='<?php echo $_GET['client_rfc_filt'] ?? null ?>' class='input-filter'></th>
                        <th><input id="client_phone_filt" onkeypress='filterClients(event);' value='<?php echo $_GET['client_phone_filt'] ?? null ?>' class='input-filter'></th>
                        <th><input id="client_type_filt" onkeypress='filterClients(event);' value='<?php echo $_GET['client_type_filt'] ?? null ?>' class='input-filter'></th>
                        <th><input id="client_disabled_filt" onkeypress='filterClients(event);' value='<?php echo $_GET['client_disabled_filt'] ?? null ?>' class='input-filter'></th>
                        <th></th>
                      </tr>
                    </thead>
