function initMenu(){
    ...
    if(session.privileges == '1'){
        ...
        '<li class="nav-item">'+
        '<a class="nav-link" href="http://cencerro.com.mx/hmconsultores/dashboard.php">'+
            '<i class="typcn typcn-device-desktop menu-icon"></i>'+
            '<span class="menu-title">Dashboard</span>'+
        '</a>'+
        '</li>'+
        '<li class="nav-item">'+
        '<a class="nav-link" href="http://cencerro.com.mx/hmconsultores/sections/users/list.php">'+
        ...
        '<div class="collapse" id="ui-clients">'+
            '<ul class="nav flex-column sub-menu">'+
            '<li class="nav-item"> <a class="nav-link" href="http://cencerro.com.mx/hmconsultores/sections/clients/list.php">Lista</a></li>'+
            '</ul>'+
        '</div>'+
        '</li>'+
    '</ul>';
...
if (session.privileges == '10') {
    ...
    '</li>'+
    '<li class="nav-item">'+
    '<a class="nav-link" href="http://cencerro.com.mx/hmconsultores/sections/my_debts/list.php">'+
        '<i class="fas fa-dollar-sign"></i>'+
        '<span class="menu-title">Cuentas por pagar</span>'+
    '</a>'+
    '</li>'+
    '<li class="nav-item">'+
    '<a class="nav-link" href="http://cencerro.com.mx/hmconsultores/sections/my_pays/list.php">'+
