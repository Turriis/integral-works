        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light">Ingresa tu correo electrónico.</h6>
              <form id="form-recovery" class="pt-3">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn btn-hm-consultores" href="javascript:void(0)" onclick="recovery_password()">RECUPERAR</a>
                </div>
              </form>
            </div>
          </div>
