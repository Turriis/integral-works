<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
            <a class="logo-integral-dashboard" href="http://localhost/Base_admin/BASE_ADMIN__HMCONSULTORES/plataforma/dashboard.php"><img src="../../resources/images/logo.jpeg" alt="logo" /></a>
            <a class="navbar-brand brand-logo-mini" href="http://localhost/Base_admin/BASE_ADMIN__HMCONSULTORES/plataforma/dashboard.php"><img src="../../resources/images/logo-mini.svg" alt="logo" /></a>
